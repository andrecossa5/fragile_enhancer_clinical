...
cols <- c("icgc_mutation_id", "icgc_donor_id", "project_code", "icgc_specimen_id", "icgc_sample_id", "chromosome", 
          "start", "end", "mutation_type", "reference_genome_allele", "mutated_from_allele","mutated_to_allele")
