...
brcaD_SSMs <- enh_SSMs_tables$CtIP[enh_SSMs_tables$CtIP$icgc_donor_id %in% brcaD, ]
brcaN_SSMs <- enh_SSMs_tables$CtIP[enh_SSMs_tables$CtIP$icgc_donor_id %in% brcaN, ]
