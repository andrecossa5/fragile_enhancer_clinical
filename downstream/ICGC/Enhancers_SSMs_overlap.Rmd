...
OUT_FOLDER_DATA <- fs::path("/Users/ieo6983/Desktop/fragile_enhancer_clinical/results/ICGC/enhancers_SSMs_overlaps/data/")
OUT_FOLDER_PLOTS <- fs::path("/Users/ieo6983/Desktop/fragile_enhancer_clinical/results/ICGC/enhancers_SSMs_overlaps/plots/")
...
```{r}
OUT_FOLDER <- fs::path("/Users/ieo6983/Desktop/enhancers_project_old/per_ivan/")
#enh_SSMs_all[["CtIP"]] %>% dplyr::select(., icgc_donor_id, icgc_mutation_id, seqnames_sbj, start_sbj, end_sbj, mutation_type, mutated_from_allele, mutated_to_allele, name, cluster) %>% write_tsv(fs::path(OUT_FOLDER, "Table_enh_SSMs_CtIP.all_overlaps.1kb_WIN.ICGC.ivan.tsv"))

#enh_SSMs_all[["GRHL"]] %>% dplyr::select(., icgc_donor_id, icgc_mutation_id, seqnames_sbj, start_sbj, end_sbj, mutation_type, mutated_from_allele, mutated_to_allele, name, cluster) %>% write_tsv(fs::path(OUT_FOLDER, "Table_enh_SSMs_GRHL.all_overlaps.1kb_WIN.ICGC.ivan.tsv"))
