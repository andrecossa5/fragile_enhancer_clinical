...
for(marker in tolower(MARKERS)){
  ...
  ggsave(plot=d, filename = paste0("/Users/ieo6983/Desktop/fragile_enhancer_clinical/results/Hartwig/snvs_distribution_over_enhancers/plots/density.snvs_distribution_over_enhancers.", marker,".all_clusters.hartwig_vs_icgc.png"), 
...
for(marker in tolower(MARKERS)){
  ...
  ggsave(plot=d, filename = paste0("/Users/ieo6983/Desktop/fragile_enhancer_clinical/results/Hartwig/snvs_distribution_over_enhancers/plots/density.snvs_distribution_over_enhancers.", marker,".high_cluster.hartwig_vs_icgc.png"), 
         device = "png", width = 7, height = 5)
}
...
for(marker in (MARKERS)){
  cowplot::plot_grid("title", plotlist = plot_list[[marker]], ncol = 1) %>%
    ggsave(., filename = paste0("/Users/ieo6983/Desktop/fragile_enhancer_clinical/results/Hartwig/snvs_distribution_over_enhancers/plots/density.snvs_distribution_over_enhancers.", marker,".each_cluster.hartwig_vs_icgc.png"), 
           device = "png", width = 7, height = 22)
}
